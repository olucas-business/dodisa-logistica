  ...
  return (
    <div id="modulo-analytics-container" className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        ...
        <RadialGauge label="Combustível" value={fuelSpendRingPercentage} displayValue={`R$ ${totalRefuelsCost.toLocaleString("pt-BR", { maximumFractionDigits: 0 })} / ${fuelSpendRingPercentage.toFixed(0)}%`} />
        <RadialGauge label="Comissão" value={comissaoPercentage} displayValue={`R$ ${totalComissao.toLocaleString("pt-BR", { maximumFractionDigits: 0 })} / ${comissaoPercentage.toFixed(0)}%`} />
