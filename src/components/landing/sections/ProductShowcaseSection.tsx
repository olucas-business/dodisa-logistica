...
export default function ProductShowcaseSection({ reduced }: SectionProps) {
  return (
    <SectionReveal reduced={reduced} className="relative z-10 max-w-5xl mx-auto px-6 py-24 md:py-36">
      <div className="text-center max-w-lg mx-auto mb-14">
        <h2>Assim é o Fleet One por dentro.</h2>
      </div>

      <div
        className="rounded-3xl border border-white/10 shadow-2xl p-6 md:p-10"
